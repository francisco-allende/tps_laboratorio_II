...
namespace TPFinal_Heladeria_Froddo
{
    public partial class Form_MenuPrincipal : Form, IBaseDeDatos
    {
        ...
        {
            Helado helado0 = new(0, 25, ETipoPostre.Helado, "Chocolate");
            Helado helado1 = new(1, 10, ETipoPostre.Helado, "Chocolate Amargo");
            Helado helado2 = new(2, 25, ETipoPostre.Helado, "Crema Americana");
            Helado helado3 = new(3, 30, ETipoPostre.Helado, "Dulce De Leche");
            Helado helado4 = new(4, 28, ETipoPostre.Helado, "Dulce De Leche Granizado");
            Helado helado5 = new(5, 30, ETipoPostre.Helado, "Frutilla al Agua");
            Helado helado6 = new(6, 15, ETipoPostre.Helado, "Frutilla a la Crema");
            Helado helado7 = new(7, 10, ETipoPostre.Helado, "Maracuya");
            Helado helado8 = new(8, 10, ETipoPostre.Helado, "Sambayon");
            Helado helado9 = new(9, 12, ETipoPostre.Helado, "Tiramisu");
            Helado helado10 = new(10, 30, ETipoPostre.Helado, "Naranja");
            Yogur yogur1 = new(11, 52, ETipoPostre.Yogur, "Natural");
            Yogur yogur2 = new(12, 1, ETipoPostre.Yogur, "Frutilla");
            Yogur yogur3 = new(13, 8, ETipoPostre.Yogur, "Vainilla");
            Yogur yogur4 = new(14, 5, ETipoPostre.Yogur, "Durazno");
        ...
        {
            Cliente cliente1 = new Cliente(38567412, "Gerado", "Av. Crisologo Larralde 1200");
            Cliente cliente2 = new Cliente(32450091, "Mariana", "Boyaca 4321");
