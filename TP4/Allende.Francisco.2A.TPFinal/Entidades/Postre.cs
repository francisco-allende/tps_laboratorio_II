...
namespace Entidades
{
    ...
    public class Postre //: IEsConsumible
    {
        ...
        public Postre(int id, int cantidadStock, string tipo, string sabor)
        {
            this.id = id;
        ...
        //Para el insert del SQL con ID autoincremental
        public Postre(int cantidadStock, string tipo, string sabor)
        {
            this.cantidadStock = cantidadStock;
            this.tipo = tipo;
            this.sabor = sabor;
        ...
        public Postre(string tipo, string sabor)
        {
            this.tipo = tipo;
            this.sabor = sabor;
        }
        ...
        public int CantidadStock { get => this.cantidadStock; set => this.cantidadStock = value; }
